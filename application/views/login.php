...
<body class="bg-gradient-warning" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;">
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login">
                                <div class="mt-5">
                                    <center>
                                        <img src="<?= base_url('assets/img/logopolkam.png') ?>" alt="">
                                    </center>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h2 text-light mb-4">Politeknik Kampar</h1>
